...
namespace UnityEngine.Audio
{
    ...
    public class AudioSlider : MonoBehaviour
    {
        ...
        private void Start() => _slider.SetValueWithoutNotify(PlayerPrefs.GetFloat(_name, 0.5f));
        ...
        private void SetValue(float value) { _manager?.SetMixerValue(_name, value); PlayerPrefs.SetFloat(_name, value); }
    }
}